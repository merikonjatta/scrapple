module HandlerCode
  class << self
    ...
    def confidence(page)
      ...
      textile tt tt2 ttml bas cls frm ctl vb resx v vh sv vhd vhdl vim xml dtd xsl xslt ent yaml yml).include?(page.type)
        800
    ...
    def handle(page)
      page['macros'] = false
      page['file_content'] = File.read(page.fullpath)
      page['layout'] = false
